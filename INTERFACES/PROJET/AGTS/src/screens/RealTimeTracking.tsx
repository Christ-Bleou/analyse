  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="relative h-screen">
        ...
        <Button
          onClick={() => navigate(-1)}
          className="absolute top-4 left-4 bg-white text-foreground hover:bg-gray-100 shadow-lg"
        >
        ...
        <Button
          ...
          className="absolute top-4 right-4 bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg"
        >
