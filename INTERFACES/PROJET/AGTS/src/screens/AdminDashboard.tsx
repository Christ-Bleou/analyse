...
export default function AdminDashboard() {
  ...
  const COLORS = ['hsl(217, 100%, 34%)', 'hsl(210, 15%, 90%)'];

  return (
    <div className="space-y-8 animate-fadeIn">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-agts-primary">Tableau de bord</h1>
          <p className="text-gray-500">Vue d'ensemble de la flotte et des trajets.</p>
        </div>
        <Button className="bg-agts-primary hover:bg-agts-primary/90">
            ...
            <div className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={barData}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="students" name="Étudiants" fill="hsl(217, 100%, 34%)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
              ...
              <tbody>
                {[
                  ...
                  <tr key={index} className="border-b last:border-0 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <button className="text-agts-primary hover:underline font-medium">
                        Éditer
                      </button>
                    </td>
                  </tr>
